...
<Callout type="info" emoji="🔧">
  Tools are the actions the Lead Agent can take. QuantFlow provides built-in
...
QuantFlow organizes tools into four categories:
...
through QuantFlow's artifact system. This is useful for visual evidence, UI checks,
